...
describe("Testing country type for SchemaParserClass", function () {
  it("1. Given a valid schema, it should return the correct response", function () {
    const schema = {
      test: {
        type: "country",
...
describe("Testing country-code type for SchemaParserClass", function () {
  it("1. Given a valid schema, it should return the correct response", function () {
    const schema = {
      test: {
        type: "country-code",
...
describe("Testing social-media-post type for SchemaParserClass", function () {
  ...
  it("5. Given a 100% hashtag percentage, it should return a result with hashtags", function () {
  ...
  it("6. Given a 100% url percentage, it should return a result with a URL", function () {
